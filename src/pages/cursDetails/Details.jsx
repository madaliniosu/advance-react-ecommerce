      ...
      <section className="CursDetailsContainer">
        <div className="CursDetailsInfo CursDetails">
          ...
          <div className="DetailsInfo">
            <div className="DetailsInfoItem">
              <img
                ...
                src={require("../../images/details-icons/clock.png")}
                alt="info icon"
              />
              <div>
                <p>
            ...
            <div className="DetailsInfoItem">
              <img
                className="DetailsIcon"
                src={require("../../images/details-icons/hat.png")}
                alt="info icon"
              />
              <div>
                <p>
            ...
            <div className="DetailsInfoItem">
              <img
                className="DetailsIcon"
                src={require("../../images/details-icons/pig.png")}
                alt="info icon"
              />
              <div>
                <p>
          ...
          <div className="DetailsParticipanti DetailsInfoText">
            <img
              className="DetailsIcon2"
              src={require("../../images/details-icons/light-bulb.png")}
              alt="info icon"
            />
        ...
        <div className="CursDetailsImg CursDetails">
          <img
            ...
            src={require(`../../images/cursuri-images/${image}`)}
            alt="cake"
          />
        </div>
      </section>
        ...
        <div className="TestimonialCardSection">
          <div className="TestimonialCard">
            <div className="TestimonialCardTitle">
              <img
                src={require("../../images/testimoniale/testimonial1.png")}
                alt="testimonial"
              />
              <div>
          ...
          <div className="TestimonialCard">
            <div className="TestimonialCardTitle">
              <img
                src={require("../../images/testimoniale/testimonial2.png")}
                alt="testimonial"
              />
              <div>
                <h4>Andrei Constatinescovici</h4>
          ...
          <div className="TestimonialCard">
            <div className="TestimonialCardTitle">
              <img
                src={require("../../images/testimoniale/testimonial3.png")}
                alt="testimonial"
              />
              <div>
                <h4>Andrei Constatinescovici</h4>
